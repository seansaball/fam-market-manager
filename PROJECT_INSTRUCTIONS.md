...
>
> **Last updated:** 2026-04-29 — v1.9.9
...
- `fam/__init__.py` reports `__version__ = "2.0.5"` — final
  ship-and-forget release.  Bundles v2.0.4 plus a user-reported
  Error Log Sheets-traceback fix.  Schema v34 (unchanged).  Five CRITICAL
  ship-blockers + eight HIGH-severity hardening items landed
  on top of the v2.0.1 hardening pass.  Ready for tag/release
  pending the manual staging checklist in
  `PRE_RELEASE_ASSESSMENT_v2.0.1.md` §7.
